...
<div class="container">
  <div class="row custom-row">
    <img src="assets\img\fondogamer4.png" class="img-fluid">
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col border border-primary">
      <div class="row m-2 text-center borde-warning">
    ...
    <div class="col border border-black">
      ...
      <div class="row border border-black">
        ...
        <div class="col">
          <img src="assets\img\medio_envio\oca.png" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-8">
      ...
      <div class="accordion-item"><!--PRECIO-->
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            ...
            <p class="card-text">Todos los precios en la web incluyen el IVA, y se encuentran expresados en pesos argentinos.</p>
          </div>
        </div>
      </div>
      <div class="accordion-item"><!--FORMAS DE PAGO-->
        ...
        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            <strong>¿Cuáles son las formas de pago?</strong>
            <p class="card-text">Contamos con dos formas de pago: a través de depósito/transferencia bancaria, con la cual obtenés el precio especial, o bien, a través de los métodos Pago Gamer (Visa o MasterCard) o MercadoPago (Tarjetas online, PagoFácil y RapiPago) con los cuales podés abonar en cuotas, al precio de lista.</p>
          </div>
        </div>
      </div>
      <div class="accordion-item"><!--DEPOSITO TRANSFERENCIA BANCARIA-->
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
            <p class="card-text">Deposito transferencia bancaria</p>
          </button>
        </h2>
        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            <strong>¿Cómo abono a través de depósito/transferencia?</strong>
            <p class="card-text">Una vez se realiza el pedido, te facilitamos los datos del CBU. Debes abonar e informar el pago desde nuestra web, antes de la fecha de vencimiento de la reserva.</p>
          </div>
        </div>
      </div>
