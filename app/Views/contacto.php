...
<div class="col-12 container titulo-contacto text-center border border-black">
    <div class="row">
...
<div class="container">
    <div class="row">
        <div class="col-12 col-md-6- col-sm-6 info-contacto bg-danger text-white p-3">
        ...
        <div class="col-12 col-md-6- col-sm-6 descripcion-contacto bg-black text-white p-3">
...
<div class="container centered-form">
    <div class="form-container bg-warning h-100">
        <div class="container">
            <h2>Contactános</h2>
            <form>
...
<div class="row align-items-center m-2">
    ...
    <!-- FORMULARIO -->
    <div class="formulario-contenedor container col-12 col-lg-6 mb-5 border border-primary">
        <div class="row mb-3">
            <p class="fs-3 text-center">
                <i class="bi bi-envelope-paper"></i>Contáctenos via correo</p>
        </div>
        <form class="p-3">
            <!-- Nombre y Apellido -->
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                <div class="col">
                    <button type="reset" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#myModal">Enviar</button>
                </div>
            </div>
        </form>
    </div>